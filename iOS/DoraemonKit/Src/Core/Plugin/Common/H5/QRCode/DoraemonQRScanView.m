...
- (UIView *)maskView1{
    if (!_maskView1) {
        _maskView1 = [[UIView alloc]initWithFrame:self.bounds];
        _maskView1.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.5];
        ...
        _maskView1.layer.mask = shapeLayer;
    }
    return _maskView1;
}
